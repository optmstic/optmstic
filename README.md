...
- **Academic / applied analytics projects** — coursework and capstones developed into portfolio-ready work.
- **Personal projects** — independent builds and experiments outside formal coursework.
...
**[vinyldb](https://github.com/optmstic/vinyldb) — Vinyl collection database**  
Personal database/project for organising and exploring a vinyl collection.  
`Personal Project` · `Database` · `Music`
